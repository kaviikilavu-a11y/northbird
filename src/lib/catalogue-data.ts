...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: "sd-gazebo-white-2x2", name: "White Gazebo Tent (2m x 2m)", price: 95900, colors: ["White"], description: "Foldable event gazebo, roof + 3 outer sides branded. Fuller coverage available — ask on WhatsApp.", imageUrl: "/products/sd-gazebo-white-2x2.jpg" },
      { id: "sd-gazebo-black-3x3", name: "Gazebo Tent (3m x 3m, Black Frame)", price: 109200, colors: ["White canopy / Black frame"], description: "Foldable event gazebo, steel frame, roof + 3 outer sides branded. Fuller coverage available — ask on WhatsApp.", imageUrl: "/products/sd-gazebo-black-3x3.jpg" },
      { id: "sd-gazebo-white-3x3", name: "White Gazebo Tent (3m x 3m)", price: 115500, colors: ["White"], description: "Foldable event gazebo, roof + 3 outer sides branded. Fuller coverage available — ask on WhatsApp.", imageUrl: "/products/sd-gazebo-white-3x3.jpg" },
      { id: "sd-gazebo-aluminium", name: "Aluminium Gazebo Tent (3m x 3m)", price: 137200, colors: ["White"], description: "Premium aluminium-frame event gazebo, roof + outer sides branded. Fuller coverage available — ask on WhatsApp.", imageUrl: "/products/sd-gazebo-aluminium.jpg" },
    ],
  },
  {
    id: "spin-wheels",
